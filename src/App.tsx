import React, { useState, useEffect } from 'react';
    import { Calendar, Trophy, Save, Award, Edit3, Target, Bike, Coffee, ShoppingBag, Utensils, Smartphone, CreditCard, Gift, Book, Home, Leaf, Gamepad2, Brain, Coins, Puzzle, Lightbulb, PiggyBank, BarChart3, CheckCircle2, Trash2, TrendingUp, XCircle, Wallet, Scale, FileText, Clock, ListChecks } from 'lucide-react';
    ...
    function App() {
      ...
      const challenges: Challenge[] = [
        ...
        {
            id: 'declutter',
            icon: <Trash2 className="text-gray-600" size={24} aria-hidden="true" />,
            title: 'Désencombrement',
            points: 15,
            description: 'Vendez ou donnez des objets inutilisés'
        },
        {
            id: 'mealPrep',
            icon: <ListChecks className="text-teal-500" size={24} aria-hidden="true" />,
            title: 'Planification des repas',
            points: 20,
            description: 'Planifiez les repas de la semaine pour éviter les achats impulsifs'
        }
      ];
      ...
      const calculateTotal = (type: string) => {
        ...
        const handleAddBillReminder = () => {
            if (billReminderTitle && billReminderDate) {
                ...
                setBillReminders(prevReminders => {
      ...
      const miniGames = [
        ...
        },
        {
          ...
          component: (
            ...
            {
                id: 'investmentQuiz',
                icon: <Coins className="text-yellow-600" size={24} aria-hidden="true" />,
                title: 'Quiz Investissement',
                description: 'Testez vos connaissances en investissement',
                maxPoints: 35,
                isPlaying: selectedGame === 'investmentQuiz',
                component: (
                    <div className="p-6 bg-white rounded-xl shadow-lg">
                        <h3 className="text-xl font-bold mb-4">Quiz Investissement</h3>
                        <p className="mb-4">Répondez aux questions pour tester vos connaissances en investissement.</p>
                        <button
                            onClick={() => {
                                setPoints(points + 35);
                                setShowConfetti(true);
            ...
            {
                id: 'savingsChallenge',
                icon: <PiggyBank className="text-pink-500" size={24} aria-hidden="true" />,
                title: 'Défi Épargne',
                description: 'Fixez-vous un objectif d\'épargne et suivez vos progrès',
                maxPoints: 40,
                isPlaying: selectedGame === 'savingsChallenge',
                component: (
                    <div className="p-6 bg-white rounded-xl shadow-lg">
                        <h3 className="text-xl font-bold mb-4">Défi Épargne</h3>
                        <p className="mb-4">Fixez-vous un objectif d'épargne et suivez vos progrès.</p>
                        <input
                            type="number"
